...
public class PaymentDetails {
	...
	/*
	 * public Long getOfaPaymentId() { return ofaPaymentId; }
	 * 
	 * public void setOfaPaymentId(Long ofaPaymentId) { this.ofaPaymentId =
	 * ofaPaymentId; }
	 * 
	 * public String getOfaConsumerNo() { return ofaConsumerNo; }
	 * 
	 * public void setOfaConsumerNo(String ofaConsumerNo) { this.ofaConsumerNo =
	 * ofaConsumerNo; }
	 * 
	 * public String getOfaParentConsumerNo() { return ofaParentConsumerNo; }
	 * 
	 * public void setOfaParentConsumerNo(String ofaParentConsumerNo) {
	 * this.ofaParentConsumerNo = ofaParentConsumerNo; }
	 * 
	 * public String getOfaConsumerName() { return ofaConsumerName; }
	 * 
	 * public void setOfaConsumerName(String ofaConsumerName) { this.ofaConsumerName
	 * = ofaConsumerName; }
	 * 
	 * public BigDecimal getOfaHelpAmount() { return ofaHelpAmount; }
	 * 
	 * public void setOfaHelpAmount(BigDecimal ofaHelpAmount) { this.ofaHelpAmount =
	 * ofaHelpAmount; }
	 * 
	 * public BigDecimal getOfaRefferalAmount() { return ofaRefferalAmount; }
	 * 
	 * public void setOfaRefferalAmount(BigDecimal ofaRefferalAmount) {
	 * this.ofaRefferalAmount = ofaRefferalAmount; }
	 * 
	 * public String getOfaMobile() { return ofaMobile; }
	 * 
	 * public void setOfaMobile(String ofaMobile) { this.ofaMobile = ofaMobile; }
	 * 
	 * 
	 * 
	 * public Integer getOfaStageNo() { return ofaStageNo; }
	 * 
	 * public void setOfaStageNo(Integer ofaStageNo) { this.ofaStageNo = ofaStageNo;
	 * }
	 * 
	 * 
	 * 
	 * public PaymentStatus getOfaPaymentStatus() { return ofaPaymentStatus; }
	 * 
	 * public void setOfaPaymentStatus(PaymentStatus ofaPaymentStatus) {
	 * this.ofaPaymentStatus = ofaPaymentStatus; }
	 * 
	 * public Integer getOfaCountdown() { return ofaCountdown; }
	 * 
	 * public void setOfaCountdown(Integer ofaCountdown) { this.ofaCountdown =
	 * ofaCountdown; }
	 * 
	 * public Date getOfaCreatedAt() { return ofaCreatedAt; }
	 * 
	 * public void setOfaCreatedAt(Date ofaCreatedAt) { this.ofaCreatedAt =
	 * ofaCreatedAt; }
	 * 
	 * public Date getOfaUpdatedAt() { return ofaUpdatedAt; }
	 * 
	 * public void setOfaUpdatedAt(Date ofaUpdatedAt) { this.ofaUpdatedAt =
	 * ofaUpdatedAt; }
	 */
